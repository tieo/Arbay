...
object SmartphonesCatalog {
    val products = listOf(
        ...
        KnownProduct("iPhone 16", SMARTPHONES, "Apple", "iPhone 16 -Pro -huelle -case -folie", "A3287", tags = listOf("ios")),
        ...
        KnownProduct("iPhone 15", SMARTPHONES, "Apple", "iPhone 15 -Pro -huelle -case -folie", "A2846", tags = listOf("ios")),
        KnownProduct("iPhone 14 Pro Max", SMARTPHONES, "Apple", "iPhone 14 Pro Max -huelle -case -folie", "A2894", tags = listOf("ios", "flagship")),
        KnownProduct("iPhone 14", SMARTPHONES, "Apple", "iPhone 14 -Pro -huelle -case -folie", "A2882", tags = listOf("ios")),
        ...
        KnownProduct("Samsung Galaxy S25", SMARTPHONES, "Samsung", "Galaxy S25 -Ultra -Plus -huelle -case", "SM-S931B", tags = listOf("android", "flagship")),
        ...
        KnownProduct("Samsung Galaxy S24", SMARTPHONES, "Samsung", "Galaxy S24 -Ultra -Plus -huelle -case", "SM-S921B", tags = listOf("android", "flagship")),
